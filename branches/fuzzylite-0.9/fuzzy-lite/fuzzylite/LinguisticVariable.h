...
namespace fl {
	...
	public:
		...
		virtual LinguisticTerm* term(int index) const throw (OutOfRangeException);
		virtual LinguisticTerm* term(const std::string& name) const;
		virtual int indexOf(const std::string& name) const;
		virtual LinguisticTerm* removeTerm(int index) throw (OutOfRangeException);
		virtual LinguisticTerm* removeTerm(const std::string& name) throw (InvalidArgumentException);
		virtual void deleteTerm(int index) throw (OutOfRangeException);
		virtual void deleteTerm(const std::string& name) throw (InvalidArgumentException);
