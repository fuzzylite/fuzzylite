...
public:
    ...
    QLabel *lbl_defuzzification;
    QComboBox *cbx_defuzzification;
    ...
    void setupUi(QDialog *Preferences)
    {
        ...
        formLayout->setWidget(4, QFormLayout::LabelRole, lbl_aggregation);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, cbx_aggregation);

        lbl_defuzzification = new QLabel(grx_fuzzy_operator);
        lbl_defuzzification->setObjectName(QString::fromUtf8("lbl_defuzzification"));

        formLayout->setWidget(3, QFormLayout::LabelRole, lbl_defuzzification);

        cbx_defuzzification = new QComboBox(grx_fuzzy_operator);
        cbx_defuzzification->setObjectName(QString::fromUtf8("cbx_defuzzification"));
        cbx_defuzzification->setMinimumSize(QSize(170, 0));

        formLayout->setWidget(3, QFormLayout::FieldRole, cbx_defuzzification);
    ...
    void retranslateUi(QDialog *Preferences)
    {
        ...
        lbl_defuzzification->setText(QApplication::translate("Preferences", "Defuzzification", 0, QApplication::UnicodeUTF8));
        cbx_defuzzification->clear();
        cbx_defuzzification->insertItems(0, QStringList()
