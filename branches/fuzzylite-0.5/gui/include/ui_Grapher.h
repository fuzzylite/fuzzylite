...
public:
    ...
    void setupUi(QWidget *Grapher)
    {
        ...
        gvw_canvas = new QGraphicsView(Grapher);
        ...
        gvw_canvas->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        gvw_canvas->setHorizontalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        ...
        gvw_canvas->setResizeAnchor(QGraphicsView::NoAnchor);
        gvw_canvas->setViewportUpdateMode(QGraphicsView::FullViewportUpdate);
    ...
    void retranslateUi(QWidget *Grapher)
    {
        ...
        lbl_y->setText(QApplication::translate("Grapher", ", y=", 0, QApplication::UnicodeUTF8));
        ...
        lbl_y_term_centroid->setText(QApplication::translate("Grapher", "y=", 0, QApplication::UnicodeUTF8));
        ...
        lbl_y_lvar_centroid->setText(QApplication::translate("Grapher", "y=", 0, QApplication::UnicodeUTF8));
