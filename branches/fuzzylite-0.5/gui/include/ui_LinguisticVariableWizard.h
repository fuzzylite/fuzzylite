...
public:
    ...
    QRadioButton *rbt_triangular;
    QRadioButton *rbt_trapezoidal;
    QHBoxLayout *horizontalLayout_2;
    QCheckBox *chx_from_infinity;
    QCheckBox *chx_to_infinity;
    ...
    void setupUi(QDialog *LinguisticVariableWizard)
    {
        ...
        rbt_triangular = new QRadioButton(grx_wizard);
        rbt_triangular->setObjectName(QString::fromUtf8("rbt_triangular"));
        sizePolicy2.setHeightForWidth(rbt_triangular->sizePolicy().hasHeightForWidth());
        rbt_triangular->setSizePolicy(sizePolicy2);
        rbt_triangular->setChecked(true);

        horizontalLayout->addWidget(rbt_triangular);

        rbt_trapezoidal = new QRadioButton(grx_wizard);
        rbt_trapezoidal->setObjectName(QString::fromUtf8("rbt_trapezoidal"));
        sizePolicy2.setHeightForWidth(rbt_trapezoidal->sizePolicy().hasHeightForWidth());
        rbt_trapezoidal->setSizePolicy(sizePolicy2);

        horizontalLayout->addWidget(rbt_trapezoidal);
        ...
        chx_from_infinity = new QCheckBox(grx_wizard);
        chx_from_infinity->setObjectName(QString::fromUtf8("chx_from_infinity"));
        sizePolicy2.setHeightForWidth(chx_from_infinity->sizePolicy().hasHeightForWidth());
        chx_from_infinity->setSizePolicy(sizePolicy2);

        horizontalLayout_2->addWidget(chx_from_infinity);

        chx_to_infinity = new QCheckBox(grx_wizard);
        chx_to_infinity->setObjectName(QString::fromUtf8("chx_to_infinity"));
        sizePolicy2.setHeightForWidth(chx_to_infinity->sizePolicy().hasHeightForWidth());
        chx_to_infinity->setSizePolicy(sizePolicy2);

        horizontalLayout_2->addWidget(chx_to_infinity);
    ...
    void retranslateUi(QDialog *LinguisticVariableWizard)
    {
        ...
        rbt_triangular->setText(QApplication::translate("LinguisticVariableWizard", "Triangular", 0, QApplication::UnicodeUTF8));
        rbt_trapezoidal->setText(QApplication::translate("LinguisticVariableWizard", "Trapezoidal", 0, QApplication::UnicodeUTF8));
        chx_from_infinity->setText(QApplication::translate("LinguisticVariableWizard", "-inf", 0, QApplication::UnicodeUTF8));
        chx_to_infinity->setText(QApplication::translate("LinguisticVariableWizard", "+inf", 0, QApplication::UnicodeUTF8));
        ...
        Q_UNUSED(LinguisticVariableWizard);
    } // retranslateUi
