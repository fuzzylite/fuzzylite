...
Cumulative::Cumulative(const std::string& name, const Operator* accumulationOperator)
...
void Cumulative::setAccumulationOperator(const Operator* accumulationOperator) {
