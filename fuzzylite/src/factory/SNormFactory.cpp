...
namespace fl {
    ...
    SNormFactory::SNormFactory() : ConstructionFactory<SNorm*>("SNorm") {
        ...
        registerConstructor(AlgebraicSum().className(),
                            &(AlgebraicSum::constructor));
        registerConstructor(BoundedSum().className(),
                            &(BoundedSum::constructor));
        registerConstructor(DrasticSum().className(),
                            &(DrasticSum::constructor));
        registerConstructor(EinsteinSum().className(),
                            &(EinsteinSum::constructor));
        registerConstructor(HamacherSum().className(),
                            &(HamacherSum::constructor));
        ...
        registerConstructor(UnboundedSum().className(),
                            &(UnboundedSum::constructor));
    }
