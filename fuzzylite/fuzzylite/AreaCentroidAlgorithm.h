...
public:
	...
	virtual void centroid(const LinguisticTerm* term, flScalar& centroid_x,
			flScalar& centroid_y, int samples) const = 0;
	virtual flScalar areaAndCentroid(const LinguisticTerm* term,
			flScalar& centroid_x, flScalar& centroid_y, int samples) const = 0;
};


class MidPointRectangle: public AreaCentroidAlgorithm {
public:
