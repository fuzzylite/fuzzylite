...
namespace fl {
    ...
    /**
      The RScriptExporter class is an Exporter that creates an R script to plot
      one or more surfaces of an engine for two input variables and any number
      of output variables.
    ...
    class FL_API RScriptExporter : public Exporter {
      ...
      public:
        ...
        /**
         Returns an R script plotting multiple surfaces based on the input
      ...
      protected:
        /**
         ...
         @param engine is the engine to export
         */
        virtual void writeScriptHeader(std::ostream& writer,
