...
class FL_API FllExporter : public Exporter {
 ...
 public:
  ...
  /**
    Returns a string representation of the vector of variables in the FuzzyLite
    Language
    @param variables is the vector of variables
    @return a string representation of the vector of variables in the FuzzyLite
    Language
   */
  virtual std::string toString(const std::vector<Variable*>& variables) const;
  /**
    Returns a string representation of the vector of input variables in the
    FuzzyLite Language
    @param inputVariables is the vector of input variables
    @return a string representation of the vector of input variables in the
    FuzzyLite Language
   */
  virtual std::string toString(
      const std::vector<InputVariable*>& inputVariables) const;
  /**
    Returns a string representation of the vector of output variables in the
    FuzzyLite Language
    @param outputVariables is a vector of output variables
    @return a string representation of the vector of output variables in the
    FuzzyLite Language
   */
  virtual std::string toString(
