...
#pragma warning(pop)
 ...
 public:
  ...
  virtual void append(const std::string& file,
                      ...
                      const std::string& function);
  /**
    Appends an error trace with a message to the exception. The method can be
    called utilizing the macro `FL_AT`
  ...
  /**
    Logs the exception to console and proceeds the regular execution of the
    library
