    ...
    TEST_CASE("RExporter ") {
        std::string fll
            = "Engine: mam21\n"
              ...
              "  rule: if angle is small and velocity is big then force is "
              "negSmall and force2 is posSmall2\n"
              "  rule: if angle is big and velocity is small then force is "
              "posSmall and force2 is negSmall2\n"
