...
TEST_CASE("RExporter creates plots with a single variable", "[imex]") {
  ...
  RScriptExporter().writeScriptImportingDataFrame(engine.get(),
                                                  os,
                                                  engine->getInputVariable(0),
                                                  engine->getInputVariable(1),
                                                  "/dummy/path/to/x.fld",
