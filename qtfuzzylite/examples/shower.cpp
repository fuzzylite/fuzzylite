...
int main(int argc, char* argv[]) {
    ...
    inputVariable1->addTerm(new fl::new fl::Trapezoid("cold", -30.000, -30.000, -15.000, 0.000));
    inputVariable1->addTerm(new fl::new fl::Triangle("good", -10.000, 0.000, 10.000));
    inputVariable1->addTerm(new fl::new fl::Trapezoid("hot", 0.000, 15.000, 30.000, 30.000));
    ...
    inputVariable2->addTerm(new fl::new fl::Trapezoid("soft", -3.000, -3.000, -0.800, 0.000));
    inputVariable2->addTerm(new fl::new fl::Triangle("good", -0.400, 0.000, 0.400));
    inputVariable2->addTerm(new fl::new fl::Trapezoid("hard", 0.000, 0.800, 3.000, 3.000));
