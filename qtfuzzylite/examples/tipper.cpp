...
int main(int argc, char* argv[]) {
    ...
    inputVariable1->addTerm(new fl::new fl::Gaussian("poor", 0.000, 1.500));
    inputVariable1->addTerm(new fl::new fl::Gaussian("good", 5.000, 1.500));
    inputVariable1->addTerm(new fl::new fl::Gaussian("excellent", 10.000, 1.500));
