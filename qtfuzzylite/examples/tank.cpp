...
int main(int argc, char* argv[]) {
    ...
    inputVariable1->addTerm(new fl::new fl::Trapezoid("high", -2.000, -1.000, -0.800, -0.001));
    inputVariable1->addTerm(new fl::new fl::Triangle("good", -0.150, 0.000, 0.500));
    inputVariable1->addTerm(new fl::new fl::Trapezoid("low", 0.001, 0.800, 1.000, 1.500));
    ...
    inputVariable2->addTerm(new fl::new fl::Trapezoid("falling", -0.140, -0.100, -0.060, 0.000));
    inputVariable2->addTerm(new fl::new fl::Trapezoid("rising", -0.001, 0.060, 0.100, 0.140));
