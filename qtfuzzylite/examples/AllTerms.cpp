...
int main(int argc, char* argv[]) {
    ...
    inputVariable1->setRange(-2.000, 17.400);
    ...
    inputVariable1->addTerm(new fl::SigmoidDifference("K", 8.424, 5.306, 1.526, 10.584));
    inputVariable1->addTerm(new fl::SigmoidProduct("L", 9.648, 1.390, -9.598, 12.672));
    ...
    outputVariable1->setRange(-2.000, 17.400);
    ...
    outputVariable1->addTerm(new fl::SigmoidDifference("K", 8.424, 5.306, 1.526, 10.584));
    outputVariable1->addTerm(new fl::SigmoidProduct("L", 9.648, 1.390, -9.598, 12.672));
    ...
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is A then OutputAllTerms is N", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is B then OutputAllTerms is M", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is C then OutputAllTerms is L", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is D then OutputAllTerms is K", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is E then OutputAllTerms is J", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is F then OutputAllTerms is I", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is G then OutputAllTerms is H", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is H then OutputAllTerms is G", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is I then OutputAllTerms is F", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is J then OutputAllTerms is E", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is K then OutputAllTerms is D", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is L then OutputAllTerms is C", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is M then OutputAllTerms is B", engine));
    ruleblock1->addRule(fl::MamdaniRule::parse(
            "if InputAllTerms is N then OutputAllTerms is A", engine));
