...
outputVariable1->setRange(-5.00000000, 5.00000000);
...
outputVariable1->addTerm(new fl::Bell("negBig", -5.00000000, 1.67000000, 8.00000000));
outputVariable1->addTerm(new fl::Bell("negSmall", -1.67000000, 1.67000000, 8.00000000));
outputVariable1->addTerm(new fl::Bell("posSmall", 1.67000000, 1.67000000, 8.00000000));
outputVariable1->addTerm(new fl::Bell("posBig", 5.00000000, 1.67000000, 8.00000000));
engine->addOutputVariable(outputVariable1);

fl::OutputVariable* outputVariable2 = new fl::OutputVariable;
outputVariable2->setEnabled(true);
outputVariable2->setName("force2");
outputVariable2->setRange(-5.00000000, 5.00000000);
...
outputVariable2->addTerm(new fl::Bell("negBig2", -3.00000000, 1.67000000, 8.00000000));
outputVariable2->addTerm(new fl::Bell("negSmall2", -1.00000000, 1.67000000, 8.00000000));
outputVariable2->addTerm(new fl::Bell("posSmall2", 1.00000000, 1.67000000, 8.00000000));
outputVariable2->addTerm(new fl::Bell("posBig2", 3.00000000, 1.67000000, 8.00000000));
