...
inputVariable1.addTerm(new Trapezoid("cold", -30.00000000, -30.00000000, -15.00000000, 0.00000000));
inputVariable1.addTerm(new Triangle("good", -10.00000000, 0.00000000, 10.00000000));
inputVariable1.addTerm(new Trapezoid("hot", 0.00000000, 15.00000000, 30.00000000, 30.00000000));
...
inputVariable2.addTerm(new Trapezoid("soft", -3.00000000, -3.00000000, -0.80000000, 0.00000000));
inputVariable2.addTerm(new Triangle("good", -0.40000000, 0.00000000, 0.40000000));
inputVariable2.addTerm(new Trapezoid("hard", 0.00000000, 0.80000000, 3.00000000, 3.00000000));
...
outputVariable1.addTerm(new Triangle("closeFast", -1.00000000, -0.60000000, -0.30000000));
outputVariable1.addTerm(new Triangle("closeSlow", -0.60000000, -0.30000000, 0.00000000));
outputVariable1.addTerm(new Triangle("steady", -0.30000000, 0.00000000, 0.30000000));
outputVariable1.addTerm(new Triangle("openSlow", 0.00000000, 0.30000000, 0.60000000));
outputVariable1.addTerm(new Triangle("openFast", 0.30000000, 0.60000000, 1.00000000));
...
outputVariable2.addTerm(new Triangle("closeFast", -1.00000000, -0.60000000, -0.30000000));
outputVariable2.addTerm(new Triangle("closeSlow", -0.60000000, -0.30000000, 0.00000000));
outputVariable2.addTerm(new Triangle("steady", -0.30000000, 0.00000000, 0.30000000));
outputVariable2.addTerm(new Triangle("openSlow", 0.00000000, 0.30000000, 0.60000000));
outputVariable2.addTerm(new Triangle("openFast", 0.30000000, 0.60000000, 1.00000000));
