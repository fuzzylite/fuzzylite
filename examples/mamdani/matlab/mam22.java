...
outputVariable1.addTerm(new Bell("negBig", -5.00000000, 1.67000000, 8.00000000));
outputVariable1.addTerm(new Bell("negSmall", -1.67000000, 1.67000000, 8.00000000));
outputVariable1.addTerm(new Bell("posSmall", 1.67000000, 1.67000000, 8.00000000));
outputVariable1.addTerm(new Bell("posBig", 5.00000000, 1.67000000, 8.00000000));
...
outputVariable2.addTerm(new Bell("negBig2", -3.00000000, 1.67000000, 8.00000000));
outputVariable2.addTerm(new Bell("negSmall2", -1.00000000, 1.67000000, 8.00000000));
outputVariable2.addTerm(new Bell("posSmall2", 1.00000000, 1.67000000, 8.00000000));
outputVariable2.addTerm(new Bell("posBig2", 3.00000000, 1.67000000, 8.00000000));
