...
inputVariable1->setRange(-20.00000000, 20.00000000);
inputVariable1->addTerm(new fl::Trapezoid("cold", -30.00000000, -30.00000000, -15.00000000, 0.00000000));
inputVariable1->addTerm(new fl::Triangle("good", -10.00000000, 0.00000000, 10.00000000));
inputVariable1->addTerm(new fl::Trapezoid("hot", 0.00000000, 15.00000000, 30.00000000, 30.00000000));
...
inputVariable2->addTerm(new fl::Trapezoid("soft", -3.00000000, -3.00000000, -0.80000000, 0.00000000));
inputVariable2->addTerm(new fl::Triangle("good", -0.40000000, 0.00000000, 0.40000000));
inputVariable2->addTerm(new fl::Trapezoid("hard", 0.00000000, 0.80000000, 3.00000000, 3.00000000));
engine->addInputVariable(inputVariable2);

fl::OutputVariable* outputVariable1 = new fl::OutputVariable;
outputVariable1->setEnabled(true);
outputVariable1->setName("cold");
outputVariable1->setRange(-1.00000000, 1.00000000);
...
outputVariable1->addTerm(new fl::Triangle("closeFast", -1.00000000, -0.60000000, -0.30000000));
outputVariable1->addTerm(new fl::Triangle("closeSlow", -0.60000000, -0.30000000, 0.00000000));
outputVariable1->addTerm(new fl::Triangle("steady", -0.30000000, 0.00000000, 0.30000000));
outputVariable1->addTerm(new fl::Triangle("openSlow", 0.00000000, 0.30000000, 0.60000000));
outputVariable1->addTerm(new fl::Triangle("openFast", 0.30000000, 0.60000000, 1.00000000));
engine->addOutputVariable(outputVariable1);

fl::OutputVariable* outputVariable2 = new fl::OutputVariable;
outputVariable2->setEnabled(true);
outputVariable2->setName("hot");
outputVariable2->setRange(-1.00000000, 1.00000000);
...
outputVariable2->addTerm(new fl::Triangle("closeFast", -1.00000000, -0.60000000, -0.30000000));
outputVariable2->addTerm(new fl::Triangle("closeSlow", -0.60000000, -0.30000000, 0.00000000));
outputVariable2->addTerm(new fl::Triangle("steady", -0.30000000, 0.00000000, 0.30000000));
outputVariable2->addTerm(new fl::Triangle("openSlow", 0.00000000, 0.30000000, 0.60000000));
outputVariable2->addTerm(new fl::Triangle("openFast", 0.30000000, 0.60000000, 1.00000000));
