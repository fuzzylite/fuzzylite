...
outputVariable1->addTerm(new fl::Gaussian("AboutTenPercent", 10.00000000, 2.00000000));
outputVariable1->addTerm(new fl::Gaussian("AboutFifteenPercent", 15.00000000, 2.00000000));
outputVariable1->addTerm(new fl::Gaussian("AboutTwentyPercent", 20.00000000, 2.00000000));
...
outputVariable2->addTerm(new fl::Gaussian("PlusAboutTenPercent", 1.10000000, 0.02000000));
outputVariable2->addTerm(new fl::Gaussian("PlusAboutFifteenPercent", 1.15000000, 0.02000000));
outputVariable2->addTerm(new fl::Gaussian("PlusAboutTwentyPercent", 1.20000000, 0.02000000));
