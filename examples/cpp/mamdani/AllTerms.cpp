...
inputVariable1->addTerm(fl::Discrete::create("G", 10, 2.000,0.000, 2.250,1.000, 2.500,0.500, 2.750,1.000, 3.000,0.000));
...
outputVariable1->addTerm(fl::Discrete::create("G", 10, 2.000,0.000, 2.250,1.000, 2.500,0.500, 2.750,1.000, 3.000,0.000));
...
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is A then AllOutputTerms is P", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is B then AllOutputTerms is O", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is C then AllOutputTerms is N", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is D then AllOutputTerms is M", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is E then AllOutputTerms is L", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is F then AllOutputTerms is K", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is G then AllOutputTerms is J", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is H then AllOutputTerms is I", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is I then AllOutputTerms is H", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is J then AllOutputTerms is G", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is K then AllOutputTerms is F", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is L then AllOutputTerms is E", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is M then AllOutputTerms is D", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is N then AllOutputTerms is C", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is O then AllOutputTerms is B", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if AllInputTerms is P then AllOutputTerms is A", engine));
