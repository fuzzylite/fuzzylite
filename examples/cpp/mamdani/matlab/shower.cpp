...
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is cold and flow is soft then cold is openSlow and hot is openFast", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is cold and flow is good then cold is closeSlow and hot is openSlow", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is cold and flow is hard then cold is closeFast and hot is closeSlow", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is good and flow is soft then cold is openSlow and hot is openSlow", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is good and flow is good then cold is steady and hot is steady", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is good and flow is hard then cold is closeSlow and hot is closeSlow", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is hot and flow is soft then cold is openFast and hot is openSlow", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is hot and flow is good then cold is openSlow and hot is closeSlow", engine));
ruleblock1->addRule(fl::FuzzyRule::parse("if temp is hot and flow is hard then cold is closeSlow and hot is closeFast", engine));
