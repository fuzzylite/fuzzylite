...
outputVariable.addTerm(new Constant("LOW", 0.25000000));
outputVariable.addTerm(new Constant("MEDIUM", 0.50000000));
outputVariable.addTerm(new Constant("HIGH", 0.75000000));
