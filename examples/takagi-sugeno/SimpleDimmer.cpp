...
outputVariable->addTerm(new fl::Constant("LOW", 0.25000000));
outputVariable->addTerm(new fl::Constant("MEDIUM", 0.50000000));
outputVariable->addTerm(new fl::Constant("HIGH", 0.75000000));
