...
inputVariable.addTerm(new Triangle("NEAR_1", 0.00000000, 1.00000000, 2.00000000));
inputVariable.addTerm(new Triangle("NEAR_2", 1.00000000, 2.00000000, 3.00000000));
inputVariable.addTerm(new Triangle("NEAR_3", 2.00000000, 3.00000000, 4.00000000));
inputVariable.addTerm(new Triangle("NEAR_4", 3.00000000, 4.00000000, 5.00000000));
inputVariable.addTerm(new Triangle("NEAR_5", 4.00000000, 5.00000000, 6.00000000));
inputVariable.addTerm(new Triangle("NEAR_6", 5.00000000, 6.00000000, 7.00000000));
inputVariable.addTerm(new Triangle("NEAR_7", 6.00000000, 7.00000000, 8.00000000));
inputVariable.addTerm(new Triangle("NEAR_8", 7.00000000, 8.00000000, 9.00000000));
inputVariable.addTerm(new Triangle("NEAR_9", 8.00000000, 9.00000000, 10.00000000));
...
outputVariable1.addTerm(new Constant("f1", 0.84000000));
outputVariable1.addTerm(new Constant("f2", 0.45000000));
outputVariable1.addTerm(new Constant("f3", 0.04000000));
outputVariable1.addTerm(new Constant("f4", -0.18000000));
outputVariable1.addTerm(new Constant("f5", -0.19000000));
outputVariable1.addTerm(new Constant("f6", -0.04000000));
outputVariable1.addTerm(new Constant("f7", 0.09000000));
outputVariable1.addTerm(new Constant("f8", 0.12000000));
outputVariable1.addTerm(new Constant("f9", 0.04000000));
