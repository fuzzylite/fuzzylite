...
outputVariable->addTerm(fl::Linear::create("outmf1", engine->inputVariables(), 41.373, 10.030, 3.162, 4.288, 0.339));
outputVariable->addTerm(fl::Linear::create("outmf2", engine->inputVariables(), 40.409, 10.053, 3.162, 4.288, 0.207));
outputVariable->addTerm(fl::Linear::create("outmf3", engine->inputVariables(), 41.373, 10.030, 3.162, 4.288, 0.339));
outputVariable->addTerm(fl::Linear::create("outmf4", engine->inputVariables(), 40.409, 10.053, 3.162, 4.288, 0.207));
outputVariable->addTerm(fl::Linear::create("outmf5", engine->inputVariables(), 38.561, 10.177, 3.162, 4.288, -0.049));
outputVariable->addTerm(fl::Linear::create("outmf6", engine->inputVariables(), 37.596, 10.154, 3.162, 4.288, -0.181));
outputVariable->addTerm(fl::Linear::create("outmf7", engine->inputVariables(), 38.561, 10.177, 3.162, 4.288, -0.049));
outputVariable->addTerm(fl::Linear::create("outmf8", engine->inputVariables(), 37.596, 10.154, 3.162, 4.288, -0.181));
outputVariable->addTerm(fl::Linear::create("outmf9", engine->inputVariables(), 37.596, 10.154, 3.162, 4.288, 0.181));
outputVariable->addTerm(fl::Linear::create("outmf10", engine->inputVariables(), 38.561, 10.177, 3.162, 4.288, 0.049));
outputVariable->addTerm(fl::Linear::create("outmf11", engine->inputVariables(), 37.596, 10.154, 3.162, 4.288, 0.181));
outputVariable->addTerm(fl::Linear::create("outmf12", engine->inputVariables(), 38.561, 10.177, 3.162, 4.288, 0.049));
outputVariable->addTerm(fl::Linear::create("outmf13", engine->inputVariables(), 40.408, 10.053, 3.162, 4.288, -0.207));
outputVariable->addTerm(fl::Linear::create("outmf14", engine->inputVariables(), 41.373, 10.030, 3.162, 4.288, -0.339));
outputVariable->addTerm(fl::Linear::create("outmf15", engine->inputVariables(), 40.408, 10.053, 3.162, 4.288, -0.207));
outputVariable->addTerm(fl::Linear::create("outmf16", engine->inputVariables(), 41.373, 10.030, 3.162, 4.288, -0.339));
