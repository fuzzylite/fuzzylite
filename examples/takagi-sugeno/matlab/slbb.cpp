...
inputVariable1->addTerm(new fl::Bell("in1mf1", -1.50000000, 1.50000000, 2.00000000));
inputVariable1->addTerm(new fl::Bell("in1mf2", 1.50000000, 1.50000000, 2.00000000));
...
inputVariable2->addTerm(new fl::Bell("in2mf1", -1.50000000, 1.50000000, 2.00000000));
inputVariable2->addTerm(new fl::Bell("in2mf2", 1.50000000, 1.50000000, 2.00000000));
...
inputVariable3->addTerm(new fl::Bell("in3mf1", -0.20000000, 0.20000000, 2.00000000));
inputVariable3->addTerm(new fl::Bell("in3mf2", 0.20000000, 0.20000000, 2.00000000));
...
inputVariable4->addTerm(new fl::Bell("in4mf1", -0.40000000, 0.40000000, 2.00000000));
inputVariable4->addTerm(new fl::Bell("in4mf2", 0.40000000, 0.40000000, 2.00000000));
...
outputVariable->addTerm(fl::Linear::create("outmf1", engine->inputVariables(), 1.01500000, 2.23400000, -12.66500000, -4.04600000, 0.02600000));
outputVariable->addTerm(fl::Linear::create("outmf2", engine->inputVariables(), 1.16100000, 1.96900000, -9.39600000, -6.16500000, 0.47400000));
outputVariable->addTerm(fl::Linear::create("outmf3", engine->inputVariables(), 1.50600000, 2.23400000, -12.99000000, -1.86500000, 1.42600000));
outputVariable->addTerm(fl::Linear::create("outmf4", engine->inputVariables(), 0.73400000, 1.96900000, -9.38100000, -4.68800000, -0.88000000));
outputVariable->addTerm(fl::Linear::create("outmf5", engine->inputVariables(), 0.73400000, 2.23400000, -12.85300000, -6.11000000, -1.03400000));
outputVariable->addTerm(fl::Linear::create("outmf6", engine->inputVariables(), 1.41300000, 1.96900000, -9.48500000, -6.59200000, 1.15900000));
outputVariable->addTerm(fl::Linear::create("outmf7", engine->inputVariables(), 1.22500000, 2.23400000, -12.80100000, -3.92900000, 0.36600000));
outputVariable->addTerm(fl::Linear::create("outmf8", engine->inputVariables(), 0.98500000, 1.96900000, -9.29100000, -5.11500000, -0.19500000));
outputVariable->addTerm(fl::Linear::create("outmf9", engine->inputVariables(), 0.98500000, 1.96900000, -9.29200000, -5.11500000, 0.19500000));
outputVariable->addTerm(fl::Linear::create("outmf10", engine->inputVariables(), 1.22500000, 2.23400000, -12.80200000, -3.92900000, -0.36600000));
outputVariable->addTerm(fl::Linear::create("outmf11", engine->inputVariables(), 1.41300000, 1.96900000, -9.48500000, -6.59200000, -1.15900000));
outputVariable->addTerm(fl::Linear::create("outmf12", engine->inputVariables(), 0.73400000, 2.23400000, -12.85300000, -6.11000000, 1.03400000));
outputVariable->addTerm(fl::Linear::create("outmf13", engine->inputVariables(), 0.73400000, 1.96900000, -9.38100000, -4.68800000, 0.88000000));
outputVariable->addTerm(fl::Linear::create("outmf14", engine->inputVariables(), 1.50600000, 2.23400000, -12.99000000, -1.86500000, -1.42600000));
outputVariable->addTerm(fl::Linear::create("outmf15", engine->inputVariables(), 1.16100000, 1.96900000, -9.39600000, -6.16500000, -0.47400000));
outputVariable->addTerm(fl::Linear::create("outmf16", engine->inputVariables(), 1.01500000, 2.23400000, -12.66500000, -4.04600000, -0.02600000));
