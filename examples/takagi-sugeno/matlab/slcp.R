...
engine.plot.i1i2_o1 = ggplot(engine.df, aes(in1, in4)) + 
    geom_tile(aes(fill=out)) + 
    scale_fill_gradient(low="#ffff00", high="#ff0000") + 
    stat_contour(aes(x=in1, y=in4, z=out), color="black") + 
    ggtitle("(in1, in4) = out")

engine.plot.i2i1_o1 = ggplot(engine.df, aes(in4, in1)) + 
    geom_tile(aes(fill=out)) + 
    scale_fill_gradient(low="#ffff00", high="#ff0000") + 
    stat_contour(aes(x=in4, y=in1, z=out), color="black") + 
    ggtitle("(in4, in1) = out")
