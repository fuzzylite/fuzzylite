...
inputVariable1->addTerm(new fl::Gaussian("okay", 0.00400000, 0.30000000));
...
outputVariable->addTerm(new fl::Constant("close_fast", -0.90000000));
outputVariable->addTerm(new fl::Constant("close_slow", -0.50000000));
outputVariable->addTerm(new fl::Constant("no_change", 0.00000000));
outputVariable->addTerm(new fl::Constant("open_slow", 0.30000000));
outputVariable->addTerm(new fl::Constant("open_fast", 0.90000000));
