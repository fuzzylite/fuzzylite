...
outputVariable1.output().setAccumulation(new AlgebraicSum());
...
outputVariable2.output().setAccumulation(new AlgebraicSum());
...
outputVariable3.output().setAccumulation(new AlgebraicSum());
