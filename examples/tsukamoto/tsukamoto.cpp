...
Ramps->fuzzyOutput()->setAggregation(fl::null);
...
Sigmoids->fuzzyOutput()->setAggregation(fl::null);
...
ZSShapes->fuzzyOutput()->setAggregation(fl::null);
...
Concaves->fuzzyOutput()->setAggregation(fl::null);
