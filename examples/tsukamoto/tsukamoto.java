...
inputVariable.addTerm(new Bell("small", -10.00000000, 5.00000000, 3.00000000));
inputVariable.addTerm(new Bell("medium", 0.00000000, 5.00000000, 3.00000000));
inputVariable.addTerm(new Bell("large", 10.00000000, 5.00000000, 3.00000000));
...
outputVariable1.addTerm(new Ramp("a1", 0.00000000, 0.25000000));
outputVariable1.addTerm(new Ramp("a2", 0.60000000, 0.40000000));
outputVariable1.addTerm(new Ramp("a3", 0.70000000, 1.00000000));
...
outputVariable2.addTerm(new Sigmoid("b1", 0.13000000, 30.00000000));
outputVariable2.addTerm(new Sigmoid("b2", 0.50000000, -30.00000000));
outputVariable2.addTerm(new Sigmoid("b3", 0.83000000, 30.00000000));
...
outputVariable3.addTerm(new SShape("c1", 0.00000000, 0.25000000));
outputVariable3.addTerm(new ZShape("c2", 0.30000000, 0.60000000));
outputVariable3.addTerm(new SShape("c3", 0.70000000, 1.00000000));
