...
Ramps.fuzzyOutput().setAccumulation(null);
...
Sigmoids.fuzzyOutput().setAccumulation(null);
...
ZSShapes.fuzzyOutput().setAccumulation(null);
...
Concaves.fuzzyOutput().setAccumulation(null);
